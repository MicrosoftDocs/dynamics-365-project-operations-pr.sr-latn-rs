...
- Ako kreirate novi obrazac, morate dodati ovu kolonu. U usluzi Power Query izaberite **Dodaj uslovnu kolonu** i unesite naziv za novu kolonu, kao što je **ModelID**. Unesite uslov za kolonu, gde, ako projektni zadatak nije prazan, onda \<unesite ID modela predviđanja\>; inače je prazno.
...
[![Mapiranje predložaka](./media/ProjectHourEstimatesMapping.jpg)](./media/ProjectHourEstimatesMapping.jpg)
...
- Ako kreirate novi obrazac, morate dodati ovu kolonu. U usluzi Power Query izaberite **Dodaj uslovnu kolonu** i unesite naziv za novu kolonu, kao što je **ModelID**. Unesite uslov za kolonu, gde, ako ID reda procene nije prazan, onda \<unesite ID modela predviđanja\>; inače je prazno.
...
[![Mapiranje predložaka](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)

[![Mapiranje predložaka](./media/ExpenseEstimatesMapping.jpg)](./media/ExpenseEstimatesMapping.jpg)
