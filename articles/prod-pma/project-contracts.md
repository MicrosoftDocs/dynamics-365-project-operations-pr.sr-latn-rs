...
description: Ovaj članak daje primere ugovora o projektu koje možete kreirati za različite vrste projekata i izvore finansiranja, kao i kako možete upravljati ugovorima i fakturisati klijentima projekata.
author: Yowelle
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
