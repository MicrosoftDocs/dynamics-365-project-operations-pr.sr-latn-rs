...
---
# <a name="actuals"></a>Stvarne vrednosti
...
## <a name="using-journals-to-record-costs"></a>Korišćenje glavnih knjiga za evidentiranje troškova

U aplikaciji PSA, glavne knjige vam omogućavaju da evidentirate troškove ili prihod u klasama materijala, naknade, vremena, troškova ili poreskih transakcija. Glavna knjiga ima zaglavlje, stavke i radnju **Potvrdi**. Evo nekoliko scenarija gde možete da koristite glavnu knjigu:
