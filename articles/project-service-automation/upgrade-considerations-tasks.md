...
- [Projekat](../developer/entities/msdyn_project.md)
- [Projektni tim](../developer/entities/msdyn_projectteam.md)
- [Projektni zadatak](../developer/entities/msdyn_projecttask.md)
- [Dodele resursa](../developer/entities/msdyn_resourceassignment.md)
- [Zavisnost projektnog zadatka](../developer/entities/msdyn_projecttaskdependency.md)
- [Resursi koji mogu da se rezervišu](../developer/entities/bookableresource.md)

Da biste definisali strukturnu analizu posla koju je učitao resurs, morate da dovršite sledeće korake:

1. Kreirajte novi projekat. Za više informacija o tome kako da kreirate novi projekat, pogledajte [msdyn_project](../developer/entities/msdyn_project.md).
2. Kreirajte jedan ili više zadataka. Za više informacija o tome kako da kreirate novi zadatak, pogledajte [msdyn_projecttask](../developer/entities/msdyn_projecttask.md).
3. Definišite zavisne elemente zadatka. Za još informacija pogledajte [Zavisnost projektnog zadatka](../developer/entities/msdyn_projecttaskdependency.md).
4. Dodelite članove projektnog tima projektu. Za više informacija, pogledajte [msdyn_projectteam](../developer/entities/msdyn_projectteam.md).
5. Dodelite članove projektnog tima zadacima. Za više informacija, pogledajte [msdyn_resourceassignment](../developer/entities/msdyn_resourceassignment.md).
